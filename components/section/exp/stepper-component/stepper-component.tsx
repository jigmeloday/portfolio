                ...
                EXP_DUMMY.map( ( { id, title }, index ) => {
                    return (
                        <li key={ id } onClick={ () => setOpen( id ) }
                            ...
                            <div
                                className='flex items-center p-6 leading-[1.3rem] no-underline after:bg-[#e0e0e0] focus:outline-none dark:after:bg-neutral-600 '>
                                <span
                                    className='mr-3 cursor-pointer flex h-[14px] w-[14px] items-center justify-center rounded-full bg-[#ebedef] text-sm font-medium text-[#40464f]'/>
