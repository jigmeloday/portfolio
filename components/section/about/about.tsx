                ...
                <motion.div
                    ...
                    className='flex flex-col  items-center md:flex-row py-8  gap-[12px] justify-center lg:justify-between'>
                    {
                        ABOUT_BOX.map( ( { id, icon, title, description } ) => (
                            ...
                            >
                                <div
                                    className='flex flex-col min-h-full bg-primary-main shadow-2xl relative overflow-hidden justify-center items-center'>
                                ...
                                <div
                                    className='min-h-full w-full items-center justify-center bg-hover-main absolute flex top-60 group-hover:top-0 opacity-0 group-hover:opacity-100 transition-all duration-500'>
